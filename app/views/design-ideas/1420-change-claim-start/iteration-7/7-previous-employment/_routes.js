...
const BASE_PATH = 'design-ideas/1420-change-claim-start/iteration-7/7-previous-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/1420-change-claim-start/iteration-7/8-abroad';
...
router.get('/', function (req, res) {
  res.redirect('/design-ideas/1420-change-claim-start/iteration-7/7-previous-employment/job-ended-last-six-months');
});
...
// After asking if they were a company directot or self-employed we ask if you had another job that ended in last 9 months
