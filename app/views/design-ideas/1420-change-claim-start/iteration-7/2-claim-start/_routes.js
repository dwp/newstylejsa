...
const BASE_PATH = 'design-ideas/1420-change-claim-start/iteration-7/2-claim-start';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/1420-change-claim-start/iteration-7/3-details';
