...
const BASE_PATH = 'design-ideas/wt-1451-backdating-improving-user-journey/merged/7-previous-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/wt-1451-backdating-improving-user-journey/merged/8-abroad';
...
router.get('/', function (req, res) {
  res.redirect('/design-ideas/wt-1451-backdating-improving-user-journey/merged/7-previous-employment/job-ended-last-six-months');
});
