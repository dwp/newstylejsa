...
const LIMIT_WARNING_PATH = '/design-ideas/wt-1451-backdating-improving-user-journey/merged/9-pensions/limit-warning';
const BASE_PATH = 'design-ideas/wt-1451-backdating-improving-user-journey/merged/9-pensions/9a-current-pension';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/wt-1451-backdating-improving-user-journey/merged/10-education';
