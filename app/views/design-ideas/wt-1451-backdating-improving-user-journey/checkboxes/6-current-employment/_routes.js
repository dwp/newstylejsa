...
const BASE_PATH = 'design-ideas/wt-1451-backdating-improving-user-journey/checkboxes/6-current-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/wt-1451-backdating-improving-user-journey/checkboxes/7-previous-employment';
