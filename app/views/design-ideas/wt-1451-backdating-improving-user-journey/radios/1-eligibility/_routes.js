...
const BASE_PATH = 'design-ideas/wt-1451-backdating-improving-user-journey/radios/1-eligibility';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = 'design-ideas/wt-1451-backdating-improving-user-journey/radios/2-claim-start';
