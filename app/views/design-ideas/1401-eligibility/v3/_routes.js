...
const BASE_PATH = 'design-ideas/1401-eligibility/v3';
...
router.get('/working', function (req, res) {
  ...
  if (residence === 'eligibility-residence-no') {
    res.redirect('/design-ideas/1401-eligibility/v3/ineligible-residency');
  } else {
    res.render('design-ideas/1401-eligibility/v3/working');
  }
});
...
router.get('/working-over', function (req, res) {
  ...
  if (working === 'eligibility-working-no') {
    res.redirect('/design-ideas/1401-eligibility/v3/contributions');
  } else {
    res.render('design-ideas/1401-eligibility/v3/working-over');
  }
});
...
router.get('/contributions', function (req, res) {
  ...
  if (workingOver === 'eligibility-working-over-yes') {
    res.redirect('/design-ideas/1401-eligibility/v3/ineligible-more-than-16-hours');
  } else {
    res.render('design-ideas/1401-eligibility/v3/contributions');
  }
});

// after contributions we do eligible
router.get('/eligible', function (req, res) {
  var answer = req.query.eligibilityContributions;
  if (answer === 'eligibility-contributions-no') {
    res.redirect('/design-ideas/1401-eligibility/v3/ineligible');
  } else if (answer === 'eligibility-contributions-not-sure') {
    res.redirect('/design-ideas/1401-eligibility/v3/unsure');
  } else {
    res.render('design-ideas/1401-eligibility/v3/eligible');
  }
});
...
router.post('/ineligible-residency', function (req, res) {
  ...
  if (answer === 'do-next-other') {
    ...
    res.redirect('/design-ideas/1401-eligibility/v3/working');
  }
});
