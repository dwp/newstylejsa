...
const BASE_PATH = 'design-ideas/1401-eligibility/v2';
...
router.get('/working', function (req, res) {
  ...
  if (residence === 'eligibility-residence-no') {
    res.redirect('/design-ideas/1401-eligibility/v2/ineligible-residency');
  } else {
    res.render('design-ideas/1401-eligibility/v2/working');
  }
});
...
router.get('/working-over', function (req, res) {
  ...
  if (working === 'eligibility-working-no') {
    res.redirect('/design-ideas/1401-eligibility/v2/contributions');
  } else {
    res.render('design-ideas/1401-eligibility/v2/working-over');
  }
});
...
router.get('/contributions', function (req, res) {
  ...
  if (workingOver === 'eligibility-working-over-yes') {
    res.redirect('/design-ideas/1401-eligibility/v2/ineligible-more-than-16-hours');
  } else {
    res.render('design-ideas/1401-eligibility/v2/contributions');
  }
});
...
router.get('/eligible', function (req, res) {
  ...
  if (contributions === 'eligibility-contributions-no') {
    res.redirect('/design-ideas/1401-eligibility/v2/ineligible');
  } else {
    res.render('design-ideas/1401-eligibility/v2/eligible');
  }
});
...
router.post('/ineligible-residency', function (req, res) {
  ...
  if (answer === 'do-next-other') {
    ...
    res.redirect('/design-ideas/1401-eligibility/v2/working');
  }
});
