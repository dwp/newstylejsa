...
const BASE_PATH = 'design-ideas/1401-eligibility/v5';
...
router.get('/working', function (req, res) {
  ...
  if (residence === 'eligibility-residence-no') {
    res.redirect('/design-ideas/1401-eligibility/v5/ineligible-residency');
  } else {
    res.render('design-ideas/1401-eligibility/v5/working');
  }
});
...
router.get('/working-over', function (req, res) {
  ...
  if (working === 'eligibility-working-no') {
    res.redirect('/design-ideas/1401-eligibility/v5/contributions');
  } else {
    res.render('design-ideas/1401-eligibility/v5/working-over');
  }
});
...
router.get('/contributions', function (req, res) {
  ...
  if (workingOver === 'eligibility-working-over-yes') {
    res.redirect('/design-ideas/1401-eligibility/v5/ineligible-more-than-16-hours');
  } else {
    res.render('design-ideas/1401-eligibility/v5/contributions');
  }
});

// after contributions we do eligible
router.post('/contributions', function (req, res) {
  var contributions = req.session.data['eligibilityContributions'];
  if (contributions === 'eligibility-contributions-yes') {
    res.redirect('/design-ideas/1401-eligibility/v5/eligible?eligible=yes');
  } else {
    res.redirect('/design-ideas/1401-eligibility/v5/benefits');
  }
});

router.post('/benefits', function (req, res) {
  var answer = req.session.data['eligibilityBenefits'];
  if (answer === 'eligibility-benefits-no') {
    res.redirect('/design-ideas/1401-eligibility/v5/ineligible');
  } else if (answer === 'eligibility-benefits-yes-some') {
    res.redirect('/design-ideas/1401-eligibility/v5/eligible?eligible=might');
  } else {
    res.redirect('/design-ideas/1401-eligibility/v5/eligible?eligible=yes');
  }
});
...
//     res.redirect('/design-ideas/1401-eligibility/v5/ineligible');
//   } else {
//     res.render('design-ideas/1401-eligibility/v5/eligible');
//   }
// });
...
router.post('/ineligible-residency', function (req, res) {
  ...
  if (answer === 'do-next-other') {
    ...
    res.redirect('/design-ideas/1401-eligibility/v5/working');
  }
});
