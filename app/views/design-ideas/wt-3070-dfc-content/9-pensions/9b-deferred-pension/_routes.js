...
const LIMIT_WARNING_PATH = '/design-ideas/wt-3070-dfc-content/9-pensions/limit-warning';
const BASE_PATH = 'design-ideas/wt-3070-dfc-content/9-pensions/9b-deferred-pension';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/wt-3070-dfc-content/9-pensions/9c-future-pension';
