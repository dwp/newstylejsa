...
const BASE_PATH = 'design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/4-other-benefits';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/5-jury-service';
