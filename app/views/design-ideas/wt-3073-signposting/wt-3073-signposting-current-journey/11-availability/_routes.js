...
const BASE_PATH = 'design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/11-availability';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/check-answers';
