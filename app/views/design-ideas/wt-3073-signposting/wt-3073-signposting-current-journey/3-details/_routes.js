...
const BASE_PATH = 'design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/3-details';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/4-other-benefits';
...
router.post('/address', function (req, res) {
  ...
  if (currentYear - dobYear < 16) {
    res.redirect('/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/3-details/dob?under16');
  } else if (currentYear - dobYear > 64) {
    res.redirect('/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/3-details/dob?over64');
  } else if (currentYear - dobYear === 16) {
    res.redirect('/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/3-details/under18');
  } else if (currentYear - dobYear === 17) {
    res.redirect('/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/3-details/under18');
  } else {
    res.redirect('/design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/3-details/address');
  }
});
