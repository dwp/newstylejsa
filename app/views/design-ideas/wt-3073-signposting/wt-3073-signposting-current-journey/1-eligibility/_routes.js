...
const BASE_PATH = 'design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/1-eligibility';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = 'design-ideas/wt-3073-signposting/wt-3073-signposting-current-journey/2-claim-start';
 ...
 * The citizen doesn't live in England, Scotland or Wales or Northern Ireland
 * 
 * 3. ineligible-residency-more-than-16-hours =
 * The citizen doesn't live in England, Scotland or Wales or Northern Ireland and is working over 16 hours per week
 *
 * 4. ineligible ==
 * The citizen hasn't contributed enough NI
 *
 * Please note: the content of page number 4 should be copied to the other two
 * */
