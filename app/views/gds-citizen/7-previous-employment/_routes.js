...
const BASE_PATH = 'gds-citizen/7-previous-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/gds-citizen/8-abroad';
...
router.get('/', function (req, res) {
  res.redirect('/gds-citizen/7-previous-employment/job-ended-last-six-months');
});
