...
router.get('/working', function (req, res) {
  ...
  if (residence === 'eligibility-residence-no') {
    res.redirect('/v1_1-citizen/1-eligibility/ineligible-residency');
  } else {
    res.render('v1_1-citizen/1-eligibility/working');
  }
});
...
router.get('/working-over', function (req, res) {
  ...
  if (working === 'eligibility-working-no') {
    res.redirect('/v1_1-citizen/1-eligibility/contributions');
  } else {
    res.render('v1_1-citizen/1-eligibility/working-over');
  }
});
...
router.get('/contributions', function (req, res) {
  ...
  if (workingOver === 'eligibility-working-over-yes') {
    res.redirect('/v1_1-citizen/1-eligibility/ineligible-more-than-16-hours');
  } else {
    res.render('v1_1-citizen/1-eligibility/contributions');
  }
});
...
router.get('/eligible', function (req, res) {
  ...
  if (contributions === 'eligibility-contributions-no') {
    res.redirect('/v1_1-citizen/1-eligibility/ineligible');
  } else {
    res.render('v1_1-citizen/1-eligibility/eligible');
  }
});
