...
const LIMIT_WARNING_PATH = '/v1_2-citizen/9-pensions/limit-warning';
const BASE_PATH = 'v1_2-citizen/9-pensions/9a-current-pension';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/v1_2-citizen/9-pensions/9b-deferred-pension';
