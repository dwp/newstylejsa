...
const LIMIT_WARNING_PATH = '/v2_2-citizen/9-pensions/limit-warning';
const BASE_PATH = 'v2_2-citizen/9-pensions/9b-deferred-pension';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/v2_2-citizen/9-pensions/9c-future-pension';
