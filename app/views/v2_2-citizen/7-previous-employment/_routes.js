...
const BASE_PATH = 'v2_2-citizen/7-previous-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/v2_2-citizen/8-abroad';
...
router.get('/', function (req, res) {
  res.redirect('/v2_2-citizen/7-previous-employment/job-ended-last-six-months');
});
